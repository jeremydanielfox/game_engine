...
public class AStar {
	public static List<GraphNodeID> run(GraphNode start, List<GraphNode> ends, Heuristic heuristicCalculator){
		PriorityQueue<TreeNode> fringe =
				new PriorityQueue<TreeNode>(100, (a,b) -> a.getCost()+a.getHeuristic() >= b.getCost()+b.getHeuristic() ? 1 : -1);	
